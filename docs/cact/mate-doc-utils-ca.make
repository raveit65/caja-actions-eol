...
# mate-doc-utils.make rather than the standard one.
#
# Rationale:
...
#   documentation machinery (mate-doc-utils, gtk-doc, dblatex, and so
#   on)
...
#
# But:
# - mate-doc-utils.make does not have any conditionals which would
#   only *build* or only *install* the documents
# - this is so a pain for the maintainer to include mate-doc-utils.make,
...
#
# But, as mate-doc-utils is deprecated to the profit of yelp-tools,
...
# required to have mate-doc-utils when just building from sources.
