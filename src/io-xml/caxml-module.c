...
{
	static const gchar *thisfn = "caxml_module_na_extension_startup";

	g_debug( "%s: module=%p", thisfn, ( void * ) module );

	caxml_provider_register_type( module );
...
{
	static const gchar *thisfn = "caxml_module_na_extension_get_version";
	guint version;
...
{
	static const gchar *thisfn = "caxml_module_na_extension_list_types";
	static GType types_list [1+CAXML_TYPES_COUNT];

	g_debug( "%s: types=%p", thisfn, ( void * ) types );

	types_list[0] = CAXML_TYPE_PROVIDER;

	types_list[CAXML_TYPES_COUNT] = 0;
	*types = types_list;

	return( CAXML_TYPES_COUNT );
}
...
{
	static const gchar *thisfn = "caxml_module_na_extension_shutdown";
