 ...
 */
struct CactIFoldersTabInterfacePrivate {
...
static void         on_tab_updatable_selection_changed( CactIFoldersTab *instance, gint count_selected );
static void         on_tab_updatable_enable_tab( CactIFoldersTab *instance, NAObjectItem *item );
static gboolean     tab_set_sensitive( CactIFoldersTab *instance );

static gboolean     on_key_pressed_event( GtkWidget *widget, GdkEventKey *event, CactIFoldersTab *instance );
static void         inline_edition( CactIFoldersTab *instance );
static void         insert_new_row( CactIFoldersTab *instance );
static void         delete_row( CactIFoldersTab *instance );

static void         add_row( CactIFoldersTab *instance, GtkTreeView *listview, const gchar *path );
static void         add_path_to_folders( CactIFoldersTab *instance, const gchar *path );
static GtkTreeView *get_folders_treeview( CactIFoldersTab *instance );
static void         on_folder_path_edited( GtkCellRendererText *renderer, const gchar *path, const gchar *text, CactIFoldersTab *instance );
static void         on_folders_selection_changed( GtkTreeSelection *selection, CactIFoldersTab *instance );
static void         on_add_folder_clicked( GtkButton *button, CactIFoldersTab *instance );
static void         on_remove_folder_clicked( GtkButton *button, CactIFoldersTab *instance );
static void         remove_path_from_folders( CactIFoldersTab *instance, const gchar *path );
static void         reset_folders( CactIFoldersTab *instance );
static void         setup_folders( CactIFoldersTab *instance );
static void         treeview_cell_edited( CactIFoldersTab *instance, const gchar *path_string, const gchar *text, gint column, gchar **old_text );
...
void
cact_ifolders_tab_initial_load_toplevel( CactIFoldersTab *instance )
{
	static const gchar *thisfn = "cact_ifolders_tab_initial_load_toplevel";
...
void
cact_ifolders_tab_runtime_init_toplevel( CactIFoldersTab *instance )
{
	static const gchar *thisfn = "cact_ifolders_tab_runtime_init_toplevel";
	GtkTreeView *listview;
	GtkTreeViewColumn *column;
	GList *renderers;
...
void
cact_ifolders_tab_all_widgets_showed( CactIFoldersTab *instance )
{
	static const gchar *thisfn = "cact_ifolders_tab_all_widgets_showed";
...
void
cact_ifolders_tab_dispose( CactIFoldersTab *instance )
{
	static const gchar *thisfn = "cact_ifolders_tab_dispose";
...
static void
on_tab_updatable_selection_changed( CactIFoldersTab *instance, gint count_selected )
{
	static const gchar *thisfn = "cact_ifolders_tab_on_tab_updatable_selection_changed";
	NAObjectItem *item;
...
static void
on_tab_updatable_enable_tab( CactIFoldersTab *instance, NAObjectItem *item )
{
	static const gchar *thisfn = "cact_ifolders_tab_on_tab_updatable_enable_tab";
...
static gboolean
tab_set_sensitive( CactIFoldersTab *instance )
{
...
static gboolean
on_key_pressed_event( GtkWidget *widget, GdkEventKey *event, CactIFoldersTab *instance )
{
	gboolean stop;
	gboolean editable;
...
static void
inline_edition( CactIFoldersTab *instance )
{
	GtkTreeView *listview;
	GtkTreeSelection *selection;
	GList *listrows;
 ...
 */
static void
insert_new_row( CactIFoldersTab *instance )
{
	GtkTreeView *listview;
	GtkTreeModel *model;
	GtkTreeIter iter;
...
static void
delete_row( CactIFoldersTab *instance )
{
	GtkTreeView *listview;
	GtkTreeModel *model;
	GtkTreeSelection *selection;
...
static void
add_row( CactIFoldersTab *instance, GtkTreeView *listview, const gchar *path )
{
	GtkTreeModel *model;
	GtkTreeIter row;
...
static void
add_path_to_folders( CactIFoldersTab *instance, const gchar *path )
{
	NAObjectAction *action;
...
static GtkTreeView *
get_folders_treeview( CactIFoldersTab *instance )
{
	GtkWidget *treeview;
...
static void
on_add_folder_clicked( GtkButton *button, CactIFoldersTab *instance )
{
#if 0
	...
	if( gtk_dialog_run( GTK_DIALOG( dialog )) == GTK_RESPONSE_ACCEPT ){
		path = gtk_file_chooser_get_filename( GTK_FILE_CHOOSER( dialog ));
		cact_iprefs_write_string( BASE_WINDOW( instance ), IPREFS_FOLDERS_PATH, path );
...
static void
on_folder_path_edited( GtkCellRendererText *renderer, const gchar *path, const gchar *text, CactIFoldersTab *instance )
{
	treeview_cell_edited( instance, path, text, FOLDERS_PATH_COLUMN, NULL );
}

static void
on_folders_selection_changed( GtkTreeSelection *selection, CactIFoldersTab *instance )
{
	gboolean editable;
	GtkWidget *button;
...
static void
on_remove_folder_clicked( GtkButton *button, CactIFoldersTab *instance )
{
	delete_row( instance );
}

static void
remove_path_from_folders( CactIFoldersTab *instance, const gchar *path )
{
	NAObjectProfile *edited;
	GSList *folders;
...
static void
reset_folders( CactIFoldersTab *instance )
{
	GtkTreeView *listview;
	GtkTreeModel *model;
...
static void
setup_folders( CactIFoldersTab *instance )
{
	NAObjectProfile *edited;
	GSList *folders, *is;
	GtkTreeView *listview;
...
static void
treeview_cell_edited( CactIFoldersTab *instance, const gchar *path_string, const gchar *text, gint column, gchar **old_text )
{
	static const gchar *thisfn = "cact_ifolders_tab_treeview_cell_edited";
	GtkTreeView *listview;
	GtkTreeModel *model;
	GtkTreeIter iter;
	GtkTreePath *path;
