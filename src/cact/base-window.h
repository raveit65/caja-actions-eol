 ...
 */
#define BASE_WINDOW_SIGNAL_INITIAL_LOAD				"cact-base-window-initial-load"
#define BASE_WINDOW_SIGNAL_RUNTIME_INIT				"cact-base-window-runtime-init"
#define BASE_WINDOW_SIGNAL_ALL_WIDGETS_SHOWED		"cact-base-window-all-widgets-showed"
