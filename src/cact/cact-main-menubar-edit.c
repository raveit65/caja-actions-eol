...
static GList  *prepare_for_paste( CactMainWindow *window );
...
static void    update_clipboard_counters( CactMainWindow *window );

/**
 * cact_main_menubar_edit_on_update_sensitivities:
 ...
 */
void
cact_main_menubar_edit_on_update_sensitivities( CactMainWindow *window, gpointer user_data, MenubarIndicatorsStruct *mis )
{
	...
	cact_main_menubar_enable_item( window, "CutItem", cut_enabled );
	...
	cact_main_menubar_enable_item( window, "CopyItem", copy_enabled );
		...
		if( mis->count_selected ){
			...
			if( paste_enabled ){
				...
				paste_enabled &= parent_item
						? cact_window_is_item_writable( CACT_WINDOW( window ), NA_OBJECT_ITEM( parent_item ), NULL )
	...
	cact_main_menubar_enable_item( window, "PasteItem", paste_enabled );
	...
	if( mis->clipboard_profiles ){
		...
		if( paste_into_enabled ){
			...
			paste_into_enabled &= cact_window_is_item_writable( CACT_WINDOW( window ), NA_OBJECT_ITEM( selected_action ), NULL );
		}
	} else {
	...
	cact_main_menubar_enable_item( window, "PasteIntoItem", paste_into_enabled );
	...
	cact_main_menubar_enable_item( window, "DuplicateItem", duplicate_enabled );
	...
	cact_main_menubar_enable_item( window, "DeleteItem", delete_enabled );
 ...
 */
void
cact_main_menubar_edit_on_cut( GtkAction *gtk_action, CactMainWindow *window )
{
	static const gchar *thisfn = "cact_main_menubar_edit_on_cut";
	...
	if( to_delete ){
		cact_main_window_move_to_deleted( window, to_delete );
		clipboard = cact_main_window_get_clipboard( window );
		cact_clipboard_primary_set( clipboard, to_delete, CLIPBOARD_MODE_CUT );
		update_clipboard_counters( window );
		cact_iactions_list_bis_delete( CACT_IACTIONS_LIST( window ), to_delete, TRUE );
	}
...
/**
 * cact_main_menubar_edit_on_copy:
 * @gtk_action: the #GtkAction action.
 * @window: the #CactMainWindow main window.
 *
 ...
 */
void
cact_main_menubar_edit_on_copy( GtkAction *gtk_action, CactMainWindow *window )
{
	static const gchar *thisfn = "cact_main_menubar_edit_on_copy";
	GList *items;
	CactClipboard *clipboard;
	...
	items = cact_iactions_list_bis_get_selected_items( CACT_IACTIONS_LIST( window ));
	clipboard = cact_main_window_get_clipboard( window );
	cact_clipboard_primary_set( clipboard, items, CLIPBOARD_MODE_COPY );
	update_clipboard_counters( window );
	na_object_unref_selected_items( items );
...
/**
 * cact_main_menubar_edit_on_paste:
 * @gtk_action: the #GtkAction action.
 * @window: the #CactMainWindow main window.
 *
 ...
 */
void
cact_main_menubar_edit_on_paste( GtkAction *gtk_action, CactMainWindow *window )
{
	static const gchar *thisfn = "cact_main_menubar_edit_on_paste";
	GList *items;
	...
	if( items ){
		cact_iactions_list_bis_insert_items( CACT_IACTIONS_LIST( window ), items, NULL );
		na_object_unref_items( items );
	}
}

/**
 * cact_main_menubar_edit_on_paste_into:
 * @gtk_action: the #GtkAction action.
 * @window: the #CactMainWindow main window.
 *
 ...
 */
void
cact_main_menubar_edit_on_paste_into( GtkAction *gtk_action, CactMainWindow *window )
{
	static const gchar *thisfn = "cact_main_menubar_edit_on_paste_into";
	GList *items;
	...
	items = prepare_for_paste( window );
	if( items ){
		cact_iactions_list_bis_insert_into( CACT_IACTIONS_LIST( window ), items );
		na_object_unref_items( items );
	}
}

static GList *
prepare_for_paste( CactMainWindow *window )
{
	static const gchar *thisfn = "cact_main_menubar_edit_prepare_for_paste";
	GList *items, *it;
	CactClipboard *clipboard;
	...
	for( it = items ; it ; it = it->next ){
		...
		relabel = cact_main_menubar_edit_is_pasted_object_relabeled( NA_OBJECT( it->data ), NA_PIVOT( updater ));
...
/**
 * cact_main_menubar_edit_on_duplicate:
 * @gtk_action: the #GtkAction action.
 * @window: the #CactMainWindow main window.
 *
 ...
 */
void
cact_main_menubar_edit_on_duplicate( GtkAction *gtk_action, CactMainWindow *window )
{
	static const gchar *thisfn = "cact_main_menubar_edit_on_duplicate";
	CactApplication *application;
	NAUpdater *updater;
	NAObjectAction *action;
	GList *items, *it;
	...
	for( it = items ; it ; it = it->next ){
		...
		relabel = cact_main_menubar_edit_is_pasted_object_relabeled( obj, NA_PIVOT( updater ));
		...
		cact_iactions_list_bis_insert_items( CACT_IACTIONS_LIST( window ), dup, it->data );
...
/**
 * cact_main_menubar_edit_on_delete:
 * @gtk_action: the #GtkAction action.
 * @window: the #CactMainWindow main window.
 *
 ...
 */
void
cact_main_menubar_edit_on_delete( GtkAction *gtk_action, CactMainWindow *window )
{
	static const gchar *thisfn = "cact_main_menubar_edit_on_delete";
	CactApplication *application;
	NAUpdater *updater;
	GList *items;
	GList *to_delete;
 ...
 */
static void
update_clipboard_counters( CactMainWindow *window )
{
	...
	g_debug( "cact_main_menubar_update_clipboard_counters: menus=%d, actions=%d, profiles=%d",
...
/**
 * cact_main_menubar_edit_on_reload:
 * @gtk_action: the #GtkAction action.
 * @window: the #CactMainWindow main window.
 *
 ...
 */
void
cact_main_menubar_edit_on_reload( GtkAction *gtk_action, CactMainWindow *window )
{
	cact_main_window_reload( window );
}

/**
 * cact_main_menubar_edit_on_preferences:
 * @gtk_action: the #GtkAction action.
 * @window: the #CactMainWindow main window.
 *
 * Edit preferences.
 */
void
cact_main_menubar_edit_on_prefererences( GtkAction *gtk_action, CactMainWindow *window )
{
	cact_preferences_editor_run( BASE_WINDOW( window ));
}

/**
 * cact_main_menubar_edit_is_pasted_object_relabeled:
 ...
 */
gboolean
cact_main_menubar_edit_is_pasted_object_relabeled( NAObject *object, NAPivot *pivot )
{
	static const gchar *thisfn = "cact_main_menubar_edit_is_pasted_object_relabeled";
	gboolean relabel;
