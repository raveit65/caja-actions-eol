...
void
cact_cclosure_marshal_VOID__BOOLEAN_INT_INT_INT (GClosure     *closure,
...
{
  typedef void (*GMarshalFunc_VOID__BOOLEAN_INT_INT_INT) (gpointer     data1,
                                                          gboolean     arg_1,
                                                          gint         arg_2,
                                                          gint         arg_3,
                                                          gint         arg_4,
...
void
cact_cclosure_marshal_VOID__POINTER_UINT (GClosure     *closure,
                                          GValue       *return_value G_GNUC_UNUSED,
                                          guint         n_param_values,
                                          const GValue *param_values,
                                          gpointer      invocation_hint G_GNUC_UNUSED,
...
void
cact_cclosure_marshal_VOID__POINTER_STRING (GClosure     *closure,
                                            GValue       *return_value G_GNUC_UNUSED,
                                            guint         n_param_values,
                                            const GValue *param_values,
                                            gpointer      invocation_hint G_GNUC_UNUSED,
