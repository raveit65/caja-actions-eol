...
static void save_item( CactMainWindow *window, NAUpdater *updater, NAObjectItem *item );

/**
 * cact_main_menubar_file_on_update_sensitivities:
 ...
 */
void
cact_main_menubar_file_on_update_sensitivities( CactMainWindow *window, gpointer user_data, MenubarIndicatorsStruct *mis )
{
	static const gchar *thisfn = "cact_main_menubar_file_on_update_sensitivities";
	...
	is_first_parent_writable = first_parent
			? cact_window_is_item_writable( CACT_WINDOW( window ), NA_OBJECT_ITEM( first_parent ), NULL )
			: mis->is_level_zero_writable;

	has_modified_items = cact_main_window_has_modified_items( window );
	...
	cact_main_menubar_enable_item( window, "NewMenuItem", new_item_enabled );
	cact_main_menubar_enable_item( window, "NewActionItem", new_item_enabled );
	...
	cact_main_menubar_enable_item( window, "NewProfileItem",
			new_profile_enabled &&
			selected_action != NULL &&
			cact_window_is_item_writable( CACT_WINDOW( window ), NA_OBJECT_ITEM( selected_action ), NULL ));

	/* save enabled if at least one item has been modified
	 * or level-zero has been resorted and is writable
	 */
	cact_main_menubar_enable_item( window, "SaveItem",
...
/**
 * cact_main_menubar_file_on_new_menu:
 ...
 */
void
cact_main_menubar_file_on_new_menu( GtkAction *gtk_action, CactMainWindow *window )
{
	NAObjectMenu *menu;
	GList *items;
...
/**
 * cact_main_menubar_file_on_new_action:
 * @gtk_action: the #GtkAction action.
 * @window: the #CactMainWindow main window.
 *
 ...
 */
void
cact_main_menubar_file_on_new_action( GtkAction *gtk_action, CactMainWindow *window )
{
...
/**
 * cact_main_menubar_file_on_new_profile:
 * @gtk_action: the #GtkAction action.
 * @window: the #CactMainWindow main window.
 *
 ...
 */
void
cact_main_menubar_file_on_new_profile( GtkAction *gtk_action, CactMainWindow *window )
{
	NAObjectAction *action;
...
/**
 * cact_main_menubar_file_on_save:
 * @gtk_action: the #GtkAction action.
 * @window: the #CactMainWindow main window.
 *
 ...
 *
 * This is the same function that #cact_main_menubar_file_save_items(), just with
 * different arguments.
 */
void
cact_main_menubar_file_on_save( GtkAction *gtk_action, CactMainWindow *window )
{
	static const gchar *thisfn = "cact_main_menubar_file_on_save";

	g_debug( "%s: gtk_action=%p, window=%p", thisfn, ( void * ) gtk_action, ( void * ) window );
	g_return_if_fail( GTK_IS_ACTION( gtk_action ));
	g_return_if_fail( CACT_IS_MAIN_WINDOW( window ));

	cact_main_menubar_file_save_items( window );
}

/**
 * cact_main_menubar_file_save_items:
 * @gtk_action: the #GtkAction action.
 * @window: the #CactMainWindow main window.
 *
 * Save items.
 * This is the same function that #cact_main_menubar_file_on_save(), just with
 * different arguments.
 */
void
cact_main_menubar_file_save_items( CactMainWindow *window )
{
	static const gchar *thisfn = "cact_main_menubar_file_save_items";
	GList *items, *it;
	 ...
	 */
	cact_main_window_remove_deleted( window );
	...
	items = cact_iactions_list_bis_get_items( CACT_IACTIONS_LIST( window ));
 ...
 */
static void
save_item( CactMainWindow *window, NAUpdater *updater, NAObjectItem *item )
{
	static const gchar *thisfn = "cact_main_menubar_file_save_item";
	NAObjectItem *origin;
	...
	if( na_object_is_modified( item ) &&
		cact_window_save_item( CACT_WINDOW( window ), item )){
			...
			cact_iactions_list_bis_remove_modified( CACT_IACTIONS_LIST( window ), item );
...
/**
 * cact_main_menubar_file_on_quit:
 * @gtk_action: the #GtkAction action.
 * @window: the #CactMainWindow main window.
 *
 ...
 */
void
cact_main_menubar_file_on_quit( GtkAction *gtk_action, CactMainWindow *window )
{
	static const gchar *thisfn = "cact_main_menubar_file_on_quit";
	...
	has_modified = cact_main_window_has_modified_items( window );
	if( !has_modified || cact_window_warn_modified( CACT_WINDOW( window ))){
