 ...
 */
void
cact_gtk_utils_set_editable( GtkObject *widget, gboolean editable )
{
 ...
 */
GdkPixbuf *
cact_gtk_utils_get_pixbuf( const gchar *name, GtkWidget *widget, gint size )
{
	static const gchar *thisfn = "cact_gtk_utils_get_pixbuf";
	GdkPixbuf* pixbuf;
	GError *error;
 ...
 */
void
cact_gtk_utils_render( const gchar *name, GtkImage *widget, gint size )
{
	GdkPixbuf* pixbuf;

	pixbuf = cact_gtk_utils_get_pixbuf( name, GTK_WIDGET( widget ), size );
